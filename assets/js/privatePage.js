...
var barangayPage = document.getElementById('barangays')
// var barangayPageValue = document.getElementById('barangays').value

if (localStorage.getItem('{"login":"login","authenticate":"authenticate"}') === '{"login":"login","authenticate":"authenticate"}') {
...
// var myLatLng = { 
//     bangkal: {lat: 14.5442801, lng: 121.0131493},
//     belAir: {lat: 14.5603971, lng: 121.0279336},
// };
...
// if (barangayPage.value === "bangkal"){
//     latsLongs = myLatLng.bangkal
// } 
// else if (barangayPage.value === "belAir"){
//     latsLongs = myLatLng.belAir
// } 
...
if (document.getElementById('infCount').value === "0"){
...
else if (document.getElementById('infCount').value > 0 && document.getElementById('infCount').value <= (document.getElementById('bldgCountNo').value/100)*1){
    var polyline = new google.maps.Polygon({
        paths:makatiPath, 
        strokeColor: "yellow", 
        strokeOpacity: 1.0, 
...
else if (document.getElementById('infCount').value > (document.getElementById('bldgCountNo').value/100)*1 && document.getElementById('infCount').value <= (document.getElementById('bldgCountNo').value/100)*5){
    var polyline = new google.maps.Polygon({
        paths:makatiPath, 
...
else if (document.getElementById('infCount').value > (document.getElementById('bldgCountNo').value/100)*5){
    var polyline = new google.maps.Polygon({
        paths:makatiPath, 
        strokeColor: "red", 
        strokeOpacity: 1.0, 
...
var bangkalPath = [
    ...
    polyline3.setMap(map2);
}

else if (barangayPage.value === "carmona"){
    ...
    var polyline35 = new google.maps.Polygon({
        paths:carmonaPath, 
        // strokeColor: "#FF0000", 
        strokeColor: "green", 
        strokeOpacity: 1.0, 
    ...
    polyline35.setMap(map2);
}

else if (barangayPage.value === "cembo"){
    ...
    polyline4.setMap(map2);
}

else if (barangayPage.value === "comembo"){
    ...
    polyline5.setMap(map2);
}

else if (barangayPage.value === "dasmarinas"){
    var dasmarinasPath = [
    ...
    polyline6.setMap(map2);
}

else if (barangayPage.value === "eastRembo"){
    var eastRemboPath = [
    ...
    polyline7.setMap(map2);
}

else if (barangayPage.value === "forbesPark"){
    var forbesParkPath = [
    ...
    polyline8.setMap(map2);
}

else if (barangayPage.value === "guadalupeNuevo"){
    ...
    polyline9.setMap(map2);
}

else if (barangayPage.value === "guadalupeViejo"){
    ...
    polyline10.setMap(map2);
}

else if (barangayPage.value === "kasilawan"){
    var kasilawanPath = [
    ...
    polyline11.setMap(map2);
}

else if (barangayPage.value === "laPaz"){
    var laPazPath = [
    ...
    polyline12.setMap(map2);
}

else if (barangayPage.value === "magallanes"){
    var magallanesPath = [
    ...
    polyline13.setMap(map2);
}

else if (barangayPage.value === "olympia"){
    var olyimpiaPath = [
    ...
    polyline14.setMap(map2);
}

else if (barangayPage.value === "palanan"){
    var palananPath = [
    ...
    polyline15.setMap(map2);
}

else if (barangayPage.value === "pembo"){
    var pemboPath = [
    ...
    polyline16.setMap(map2);
}

else if (barangayPage.value === "pinagkaisahan"){
    ...
    polyline17.setMap(map2);
}

else if (barangayPage.value === "pioDelPilar"){
    var pioDelPilarPath = [
    ...
    polyline18.setMap(map2);
}

else if (barangayPage.value === "pitogo"){
    var pitogoPath = [
    ...
    polyline19.setMap(map2);
}

else if (barangayPage.value === "poblacion"){
    var poblacionPath = [
    ...
    polyline20.setMap(map2);
}

else if (barangayPage.value === "postProperNorthside"){
    ...
    polyline21.setMap(map2);
}

else if (barangayPage.value === "postProperSouthside"){
    ...
    polyline22.setMap(map2);
}

else if (barangayPage.value === "rizal"){
    var rizalPath = [
    ...
    polyline23.setMap(map2);
}

else if (barangayPage.value === "sanAntonio"){
    var sanAntonioPath = [
    ...
    polyline24.setMap(map2);
}

else if (barangayPage.value === "sanIsidro"){
    var sanIsidroPath = [
    ...
    polyline25.setMap(map2);
}

else if (barangayPage.value === "sanLorenzo"){
    var sanLorenzoPath = [
    ...
    polyline26.setMap(map2);
}

else if (barangayPage.value === "singkamas"){
    var singkamasPath = [
    ...
    polyline27.setMap(map2);
}

else if (barangayPage.value === "southCembo"){
    var southCemboPath = [
    ...
    polyline28.setMap(map2);
}

else if (barangayPage.value === "staCruz"){
    var santaCruzPath = [
    ...
    polyline29.setMap(map2);
}

else if (barangayPage.value === "tejeros"){
    var tejerosPath = [
    ...
    polyline30.setMap(map2);
}

else if (barangayPage.value === "urdaneta"){
    var urdanetaPath = [
    ...
    polyline31.setMap(map2);
}

else if (barangayPage.value === "valenzuela"){
    var valenzuelaPath = [
...
for(i=0; i < localStorage.length; i++){
    ...
    if (JSON.parse(localStorage.getItem(localStorage.key([i]))).status === "infected" && JSON.parse(localStorage.getItem(localStorage.key([i]))).barangay === barangayPage.value){
        var marker = new google.maps.Marker({
            position: JSON.parse(localStorage.key(i)),
            map: map2,
            animation: google.maps.Animation.DROP,
            title: 'Barangay Bel-Air',
            icon: "/assets/images/infectedmarker.png"
        });


        infowindow2.setContent( 
            "<strong>Surveyee's Name: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).name
            + " <br /> " +
            "<strong>Barangay: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).barangay
            + " <br /> " +
            "<strong>No. of Occupants: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).occupants
            + " <br /> " +
            "<strong>Contact: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).contact
            + " <br /> " +
            "<strong>Fever level: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).temp
            + " <br /> " +
            "<strong>Travel History: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).travel
            + " <br /> " +
            "<strong>Showing Symptoms: </strong>" + JSON.parse(localStorage.getItem(localStorage.key([i]))).symptoms
            + " <br /> " +
            "<strong>LatLng: </strong>" + (localStorage.key(i))
            );
        infowindow2.open(map2,marker);
    }

    else if (JSON.parse(localStorage.getItem(localStorage.key([i]))).status === "healthy" && JSON.parse(localStorage.getItem(localStorage.key([i]))).barangay === barangayPage.value){
        var marker = new google.maps.Marker({
            position: JSON.parse(localStorage.key(i)),
            map: map2,
            animation: google.maps.Animation.DROP,
            title: 'Barangay Bel-Air',
            icon: "/assets/images/healthymarker.png"
        });
...
for(c=0; c < localStorage.length; c++){
    ...
    if(JSON.parse(localStorage.getItem(localStorage.key([c]))).status === "healthy" && JSON.parse(localStorage.getItem(localStorage.key([c]))).barangay === barangayPage.value){
        healthC += 1
        console.log(1)

    }

    else if(JSON.parse(localStorage.getItem(localStorage.key([c]))).status === "infected" && JSON.parse(localStorage.getItem(localStorage.key([c]))).barangay === barangayPage.value){
        infC += 1
        console.log(1)
    }

    document.getElementById('healthyCount').value = healthC 
    document.getElementById('infCount').value = infC 
}

}

// FETCH/REMOVE MARKERS------------------------------------------------------------------------------------------------------------
...
function removeMarker() {   
    localStorage.removeItem(document.getElementById('markerName').value)
    // location.reload()
    initMap()
}

function removeIni() {   
    if(document.getElementById('markerName').style.display === "none"){
        document.getElementById('markerName').style.display = "flex"
    }
...
function login() {   
    ...
    if(barangayPage.value === "bangkal" && document.getElementById('authent').value === "111"){

        initMap()
        localStorage.setItem('{"login":"login","authenticate":"authenticate"}','{"login":"login","authenticate":"authenticate"}');
        document.getElementById('loginPage').style.display = "none";
        }

    else if(barangayPage.value === "belAir" && document.getElementById('authent').value === "222"){
    ...
    else if(barangayPage.value === "carmona" && document.getElementById('authent').value === "333"){
    ...
    else if(barangayPage.value === "cembo" && document.getElementById('authent').value === "444"){
    ...
    else if(barangayPage.value === "comembo" && document.getElementById('authent').value === "555"){
    ...
    else if(barangayPage.value === "dasmarinas" && document.getElementById('authent').value === "666"){
    ...
    else if(barangayPage.value === "eastRembo" && document.getElementById('authent').value === "777"){
    ...
    else if(barangayPage.value === "forbesPark" && document.getElementById('authent').value === "888"){
    ...
    else if(barangayPage.value === "guadalupeNuevo" && document.getElementById('authent').value === "999"){
    ...
    else if(barangayPage.value === "guadalupeViejo" && document.getElementById('authent').value === "101010"){
    ...
    else if(barangayPage.value === "kasilawan" && document.getElementById('authent').value === "111111"){
    ...
    else if(barangayPage.value === "laPaz" && document.getElementById('authent').value === "121212"){
    ...
    else if(barangayPage.value === "magallanes" && document.getElementById('authent').value === "131313"){
    ...
    else if(barangayPage.value === "olympia" && document.getElementById('authent').value === "141414"){
    ...
    else if(barangayPage.value === "palanan" && document.getElementById('authent').value === "151515"){
    ...
    else if(barangayPage.value === "pembo" && document.getElementById('authent').value === "161616"){
    ...
    else if(barangayPage.value === "pinagkaisahan" && document.getElementById('authent').value === "171717"){
    ...
    else if(barangayPage.value === "pioDelPilar" && document.getElementById('authent').value === "181818"){
    ...
    else if(barangayPage.value === "pitogo" && document.getElementById('authent').value === "191919"){
    ...
    else if(barangayPage.value === "poblacion" && document.getElementById('authent').value === "202020"){
    ...
    else if(barangayPage.value === "postProperNorthside" && document.getElementById('authent').value === "212121"){
    ...
    else if(barangayPage.value === "postProperSouthside" && document.getElementById('authent').value === "222222"){
    ...
    else if(barangayPage.value === "rizal" && document.getElementById('authent').value === "232323"){
    ...
    else if(barangayPage.value === "sanAntonio" && document.getElementById('authent').value === "242424"){
    ...
    else if(barangayPage.value === "sanIsidro" && document.getElementById('authent').value === "252525"){
    ...
    else if(barangayPage.value === "sanLorenzo" && document.getElementById('authent').value === "262626"){
    ...
    else if(barangayPage.value === "singkamas" && document.getElementById('authent').value === "272727"){
    ...
    else if(barangayPage.value === "southCembo" && document.getElementById('authent').value === "282828"){
    ...
    else if(barangayPage.value === "staCruz" && document.getElementById('authent').value === "292929"){
    ...
    else if(barangayPage.value === "tejeros" && document.getElementById('authent').value === "303030"){
    ...
    else if(barangayPage.value === "urdaneta" && document.getElementById('authent').value === "313131"){
    ...
    else if(barangayPage.value === "valenzuela" && document.getElementById('authent').value === "323232"){
    ...
    else if(barangayPage.value === "westRembo" && document.getElementById('authent').value === "333333"){
        ...
        // document.getElementById('failLogin').innerHTML = "Login failed! Please send a request ticket and proof of Identitity at contacttracerdev@gmail.com for your authentication key."
        alert("Login failed! Please send a request ticket and proof of Identitity at contacttracerdev@gmail.com for your authentication key.");
    }
}

function logout1() {   
    // document.getElementById('doubleC').innerHTML = "Double click to log-out."
    // alert("Double click to log-out.")

}

function logout2() {   
    localStorage.removeItem('{"login":"login","authenticate":"authenticate"}')
    location.reload()
}


    // const breakAnim = document.getElementById("breakAnimate");
	// const breakStart = document.getElementById("break1");

	// var timerSet;

	// breakAnim.addEventListener("mouseover", breakStart1);
	// breakAnim.addEventListener("mouseout", breakStart5);


	// // FORWARD

	// function breakStart1() {
	// 	breakStart.src = "assets/images/parallax/break2.png";
	// 	timerSet = setTimeout(breakStart2, 100); 
	// }

	// function breakStart2() {
	// 	breakStart.src = "assets/images/parallax/break3.png";
	// 	timerSet = setTimeout(breakStart3, 100); 
	// }
	
	// function breakStart3() {
	// 	breakStart.src = "assets/images/parallax/break4.png";
	// 	timerSet = setTimeout(breakStart4, 100); 
	// }
	
	// function breakStart4() {
	// 	breakStart.src = "assets/images/parallax/break5.png";
    // }
    
	// function breakStart5() {
    //     breakStart.src = "assets/images/parallax/break4.png";
    //     timerSet = setTimeout(breakStart6, 100); 
    // }
        
	// function breakStart6() {
    //     breakStart.src = "assets/images/parallax/break3.png";
    //     timerSet = setTimeout(breakStart7, 100); 
    // }
        
	// function breakStart7() {
    //     breakStart.src = "assets/images/parallax/break2.png";
    //     timerSet = setTimeout(breakStart8, 100); 
    // }
        
	// function breakStart8() {
    //     breakStart.src = "assets/images/parallax/break1.png";
    // }
		...
		break4.style.display = "none"
		break5.style.display = "none"
		...
		function breakStart() {
            breakTo1 = setTimeout(function(){
				hideBreaks()
				break2.style.display = "flex"; 
			}, 100);

            breakTo2 = setTimeout(function(){
				hideBreaks()
				break3.style.display = "flex"; 
			}, 200);
		
            breakTo3 = setTimeout(function(){
				hideBreaks()
				break4.style.display = "flex"; 
			}, 300);
		
            breakTo4 = setTimeout(function(){
				hideBreaks()
				break5.style.display = "flex"; 
			}, 400);

		}

		function breakStartReverse() {

			clearTimeout(breakTo1);
			clearTimeout(breakTo2);
			clearTimeout(breakTo3);
			clearTimeout(breakTo5);
			clearTimeout(breakTo5);
		...
		const captain4 = document.getElementById('captain4')
		const captain5 = document.getElementById('captain5')
		const captain6 = document.getElementById('captain6')

		captain2.style.display = "none"
		captain3.style.display = "none"
		captain4.style.display = "none"
		captain5.style.display = "none"
		captain6.style.display = "none"
		...
		function animateCaptain() {

			capto1 = setTimeout(function(){
				hideCapts()
				captain2.style.display = "flex"; 
				console.log(1)
			}, 100);

			capto2 = setTimeout(function(){
				hideCapts()
				captain3.style.display = "flex"; 
				console.log(2)
			}, 200);
		
			capto3 = setTimeout(function(){
				hideCapts()
				captain4.style.display = "flex"; 
				console.log(3)
			}, 300);
		
			capto4 = setTimeout(function(){
				hideCapts()
				captain5.style.display = "flex"; 
				console.log(4)
			}, 400);

			capto5 = setTimeout(function(){
				hideCapts()
				captain6.style.display = "flex"; 
				console.log(5)
			}, 500);
		}

		function animateCaptainReverse() {
			clearTimeout(capto1);
			clearTimeout(capto2);
			clearTimeout(capto3);
			clearTimeout(capto4);
